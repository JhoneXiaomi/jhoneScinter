                ...
                <table class="forms" style="table-layout:fixed;">
                    <tbody>
                    	<tr>
                         ...
                         <tr>
                        	<td class="right" width="10%"><i class="require">*</i>推荐案例：</td>
                    		<td>
                    	...
                    	<tr>
                    		<td class="right" width="10%"><i class="require">*</i>案例缩略图[461x330]px：</td>
                    		<td colspan="3">
                    	...
                    	<tr>
                    		<td class="right" width="10%"><i class="require">*</i>案例图片[880x500]px：</td>
                    		<td colspan="3">
                    			<table>
                    				<tr>
                    					<td>
...
jQuery(function($){
	...
	$("#js_save").click(function(){
		$('#caseForm').form({   
		    url:'${pageContext.request.contextPath}/admin/saveFitMent',
			onSubmit : function() {
				//行政区域赋值
