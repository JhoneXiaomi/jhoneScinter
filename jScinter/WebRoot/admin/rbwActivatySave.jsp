            ...
            <div title="活动基本信息" data-options="" class="pad10 relative" id="tab1">
                ...
                <table class="forms" style="table-layout:fixed;">
                    <tbody>
                        ...
                        <!-- <tr>
                        	<td class="right" width="10%"><i class="require">*</i>推荐活动：</td>
                    		<td>
                    	...
                    	<tr>
                    		<td class="right" width="10%"><i class="require">*</i>活动作者：</td>
                    		<td>
                    			<input class="txt" id="author" name="author" type="text" value="${empty newsInfo.author ? sessionScope.UserInfo.nickName : newsInfo.author}" readonly="readonly"/>
                    		</td>
                    	...
                    	<tr>
                    		<td class="right" width="10%"><i class="require">*</i>活动类别：</td>
                    		<td>
                    			<select name="type" id="type" class="easyui-combobox" 
                    			data-options="panelHeight:'auto',editable : true,
                    			valueField: 'id',
                     			textField: 'text',
                     			url:'${pageContext.request.contextPath}/static/www/json/scinter/scActivaty_type.json',
                    		...
                    		<td><input class="txt" id="readNum" name="readNum" type="number" value="${newsInfo.readNum}" />
                    			...
                    			<!-- 用户隶属分公司信息 -->
                    			<input type="hidden" id="branchCompany" name="branchCompany" value="${empty newsInfo.branchCompany ? sessionScope.Role.branchCompany : newsInfo.branchCompany}"/>
                    			</c:if>
                    		</td>
                    	</tr>
...
jQuery(function($){
	...
	$("#js_save").click(function(){
		$('#newsForm').form({
		    url:'${pageContext.request.contextPath}/admin/saveRbwActivaty',
			onSubmit : function() {
				//隐藏表单赋值
