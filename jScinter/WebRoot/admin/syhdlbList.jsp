...
jQuery(function($){
	  ...
	  var $$=window.$$={
        ...
        loadGrid:function(param){
            $("#grid_recheck").datagrid({
                url:'${pageContext.request.contextPath}/admin/listSyhdlbToJson',
                fit:true,
                striped: true,
                pagination:true,
                pageSize: 10,
                ...
                onSelect:function(index,row){
					...
					$("#framebottom").attr("src","showSyhdlb?homeImgId="+row.homeimgId);
                },
	...
	$("#js_add").on("click",function(){
	   ...
	   $("#framebottom").attr("src","syhdlbSave.jsp");
	});
    ...
    $("#js_edit").on("click",function(){
       ...
       if(homeImgIdArr.length==1){
    	   $("#framebottom").attr("src","showSyhdlb?homeImgId="+homeImgIdArr[0]);
       }else{
	...
	$("#search").on("click",function(){
		...
		$("#grid_recheck").datagrid({url:'searchListSyhdlb'}); //重新加载查询url
		$("#grid_recheck").datagrid('reload'); //重新加载
	});
    /*window resize*/
    winResize=function(){
