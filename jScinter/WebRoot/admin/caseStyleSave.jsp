...
<div class="wrapper details notblbew" id="js_layout">
    <div data-options="region:'center'" class="noborder">
        <div class="easyui-tabs" data-options="tools:'#tab-tools'" id="tabs">
            <div title="装修风格信息" data-options="" class="pad10 relative" id="tab1">
                ...
                <table class="forms" style="table-layout:fixed;">
                    <tbody>
                    	...
                    	<tr>
                    		<td class="right"><i class="require">*</i>风格名称：</td>
                    		<td>
                    	...
                    	<tr>
                    		<td class="right"><i class="require">*</i>风格户型：</td>
                    		<td>
                    	...
                    	<tr>
                    		<td class="right" width="10%"><i class="require">*</i>风格描述：</td>
                    		<td colspan="3">
            ...
            <div title="风格图片展示" data-options="" class="pad10 relative" id="tab2">
...
jQuery(function($){
	...
	$("#js_save").click(function(){
		$('#caseForm').form({
		    url:'${pageContext.request.contextPath}/admin/saveCaseStyle',
			onSubmit : function() {
				//行政区域赋值
				...
				if(caseName==""){
					$.messager.alert("操作提示", "风格名称不能为空！","info");
					$("#caseTitle").focus();
					return false;
				}
				...
				if(designerVal=="" || designerVal == "===请选择==="){
					$.messager.alert("操作提示", "请选择风格对应的设计师！","info");
					return false;
				}
				
				var caseThumbImg = $("#caseThumbImg").val();
				if(caseThumbImg==""){
					$.messager.alert("操作提示", "请先上传风格缩略图！","info");
					return false;
				}
			},
			success : function(data) {
