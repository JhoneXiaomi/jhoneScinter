...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/www/css/upload.css" type="text/css" >
</head>
<body>
...
jQuery(function() {
    ...
    uploader = WebUploader.create({
        ...
        server: '${pageContext.request.contextPath}/admin/imgListUpload',
        fileNumLimit: 100,
